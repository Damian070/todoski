...
export class TodosEffects {
  ...
  saveToDP$ = this.actions$.pipe(
    ofType(
      fromTodosActions.Types.AddTodo,
      fromTodosActions.Types.DeleteTodo,
      fromTodosActions.Types.EditTodo,
      fromTodosActions.Types.SetTodoBackToPending,
      fromTodosActions.Types.FinishTodo
    ),
    map(action => {
      this.store
        .pipe(
